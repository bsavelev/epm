/*
 * "$Id: portable.c,v 1.11.2.39 2009/09/02 09:34:46 bsavelev Exp $"
 *
...
//  }
  ...
  if (i)
  {
    ...
    */
	...
	qprintf(scriptfile, "		/sbin/chkconfig --add %s\n", file->dst);
	fputs("	else\n", scriptfile);
...
/*
 * End of "$Id: portable.c,v 1.11.2.39 2009/09/02 09:34:46 bsavelev Exp $".
 */
